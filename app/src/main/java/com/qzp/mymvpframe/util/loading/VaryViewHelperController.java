 ...
 */
package com.qzp.mymvpframe.util.loading;
...
public class VaryViewHelperController {
    ...
    public void showNetworkError(View.OnClickListener onClickListener) {
        ...
        imageView.setImageResource(R.drawable.common_no_wifi);
        if (null != onClickListener) {
            layout.setOnClickListener(onClickListener);
        }
        helper.showLayout(layout, true);
    }
    ...
    public void showError(String errorMsg, View.OnClickListener onClickListener) {
        ...
        if (!TextUtils.isEmpty(errorMsg)) {
            if(!TextUtils.isEmpty(errorMsg)){
                ...
                textView.setText(helper.getContext().getResources().getString(R.string.common_error_friendly_msg));
            }
        } else {
            textView.setText(helper.getContext().getResources().getString(R.string.common_error_friendly_msg));
        }
    ...
    public void showLoading(String msg, boolean coverView) {
        ...
        helper.showLayout(layout, coverView);
    }
