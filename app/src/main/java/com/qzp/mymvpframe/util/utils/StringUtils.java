...
public final class StringUtils {
     ...
     *
     * @param str 待校验字符串
     * @param defaultValue 返回的默认字符串
     * @return {""}: null 或全空白字符<br> {str}: 不为 null 且不全空白字符
     */
    public static String isEmptyResuleString(String str,String defaultValue){
        if (TextUtils.isEmpty(str) || str ==null){
            return defaultValue;
        }
        return str;
     ...
     *
     * @param str 待校验字符串
     * @return {0}: null 或全空白字符<br> {int}: 不为 null 且不全空白字符
     */
    ...
    public static int isEmptyResuleInt(String str,int def){
        if (TextUtils.isEmpty(str) || str ==null)
            return def;
        if (!str.matches("^[0-9]*$"))
            return 0;
     ...
     * @return {0}: null 或全空白字符<br> {int}: 不为 null 且不全空白字符
     */
    public static Double isEmptyResuleDouble(String str){
        if (TextUtils.isEmpty(str) || str ==null){
            return 0d;
        }
     ...
     *
     * @param str 待校验字符串
     * @return {"0"}: null 或全空白字符<br> {float}: 不为 null 且不全空白字符
     */
    public static Float isEmptyResuleFloat(String str){
        if (TextUtils.isEmpty(str) || str ==null){
            return 0f;
        }
