...
public class VaryViewHelper implements IVaryViewHelper {
	...
	public void restoreView() {
		if(this.coveView){
			showLayout(view, true);
		}else {
			if(parentView == null)
				return;
			parentView.removeViewAt(viewIndex + 1);
		}
	}

	@Override
	public void showLayout(View view, boolean coverView) {
		this.coveView = coverView;
		if (parentView == null) {
			init();
		}
...
//			}
//			parentView.removeViewAt(viewIndex);
				parentView.addView(view, viewIndex + 1, params);
			}
		}
	}
